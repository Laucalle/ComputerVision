...
\newcommand\MyBox[1]{
    \fbox{\lower0.75cm
        \vbox to 1.3cm{\vfil
            \hbox to 1.3cm{\hfil\parbox{1.1cm}{\centering#1}\hfil}
        \vfil}
    }
}
\newcommand\MyOtherBox[1]{
    \setlength{\fboxrule}{0pt}
    \fbox{\lower0.75cm
        \vbox to 1.3cm{\vfil
            \hbox to 0.5cm{\hspace{0.6cm}\centering#1}
        \vfil}
    }
}
...
\newmintedfile[EscaneoFiltro]{python}{
    firstline=325,
    lastline=336,
    numbersep=5pt,
    gobble=0,
...
\newpage
                ...
                \EscaneoFiltro[label=.]{../pedestrian_detection.py}
                ...
                \begin{figure}[H]
    		        ...
    		        \begin{center}
    		        	...
    		        	\setlength{\fboxrule}{0pt}
                        \fbox{
    						\includegraphics[width=.46\textwidth]{ConLogReg-1.jpg}
    					}
                        \fbox{
    						\includegraphics[width=.46\textwidth]{ConNMS-1.jpg}
    					}
                        \fbox{
    						\includegraphics[width=.46\textwidth]{ConLogReg-2.jpg}
    					}
    					\fbox{
    						\includegraphics[width=.46\textwidth]{ConNMS-2.jpg}
    					}
                        \fbox{
    						\includegraphics[width=.46\textwidth]{ConLogReg-3.jpg}
    					}
                        \fbox{
    						\includegraphics[width=.46\textwidth]{ConNMS-3.jpg}
    					}
                ...
                \begin{figure}[H]
    		        ...
    		        \begin{center}
                        ...
                        \setlength{\fboxrule}{0pt}
                        \fbox{
    						\includegraphics[width=.46\textwidth]{ConLogReg-4.jpg}
    					}
    					\fbox{
    						\includegraphics[width=.46\textwidth]{ConNMS-4.jpg}
    					}
            ...
            \subsubsection{Estudio de las alternativas propuestas}
                ...
                \par
                Dejando a un lado la supresión de no máximos, cuya utilidad es evidente pero no influye en la calidad de la clasificación, vamos a ver las matrices de confusión del modelo original, de la alternativa por votos en mayoría simple y de la opción de incremento de umbral:
                    ...
                    \begin{center}
                        \begin{minipage}{.3\textwidth}
            				...
            				\begin{tabular}{c >{\bfseries}r @{\hspace{0.7em}}c @{\hspace{0.4em}}c @{\hspace{0.7em}}l}
                                ...
                                \multirow{10}{*}{\rotatebox{90}{\parbox{1.3cm}{\bfseries\centering Predicciones}}} &
                                & \multicolumn{2}{c}{\bfseries Valores reales} & \\

            					& & \textbf{N} & \textbf{P} \\

            					& \MyOtherBox{\textbf{N}} & \MyBox{4510} & \MyBox{56} & \\[2.4em]

            					& \MyOtherBox{\textbf{P}} & \MyBox{20} & \MyBox{1076} & \\
                        ...
                        \begin{minipage}{.3\textwidth}
            				...
            				\begin{tabular}{c >{\bfseries}r @{\hspace{0.7em}}c @{\hspace{0.4em}}c @{\hspace{0.7em}}l}
            					...
            					& \MyOtherBox{\textbf{N}} & \MyBox{4449} & \MyBox{22} & \\[2.4em]

            					& \MyOtherBox{\textbf{P}} & \MyBox{81} & \MyBox{1110} & \\

            				\end{tabular}
                            \caption{Múltiples \textit{SVM}}
                        \end{minipage}
                        \vspace{0.5cm}
                        ...
                        \begin{minipage}{.3\textwidth}
            				...
            				\begin{tabular}{c >{\bfseries}r @{\hspace{0.7em}}c @{\hspace{0.4em}}c @{\hspace{0.7em}}l}
            					...
            					& \MyOtherBox{\textbf{N}} & \MyBox{4522} & \MyBox{87} & \\[2.4em]

            					& \MyOtherBox{\textbf{P}} & \MyBox{8} & \MyBox{1045} & \\

            				\end{tabular}
                            \caption{Umbral de 80\%}
                        \end{minipage}
                    \end{center}
                \end{figure}
