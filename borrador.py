...
def cellHistogram(cell_m, cell_o):
	...
	lower_bin = (cell_o//size_bin).astype(np.uint8)
	upper_bin = (lower_bin+1)%bins

	value_to_lower = (cell_o%size_bin)/size_bin
	value_to_upper = (1-value_to_lower) * cell_m
	value_to_lower = value_to_lower * cell_m
